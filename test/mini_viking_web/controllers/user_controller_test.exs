defmodule MiniVikingWeb.UserControllerTest do
  use MiniVikingWeb.ConnCase

  import MiniViking.AccountsFixtures
  ...
  @invalid_attrs %{role: nil, first_name: nil, last_name: nil, email: nil}
